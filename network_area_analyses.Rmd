...
### second, fit ML for best model selection Zuur, pg 90
m1<-gls(log(dirt_mod_quanti+0.2216441)/(1-dirt_mod_quanti+0.2216441)~ logsize+logarea+forest.type, data=data, method="ML", correlation=corSpher(form=~x+y))
summary(m1)
dd<-dredge(m1)
print(dd)
summary(get.models(dd,1)[[1]])
...
## finally, refit best models with REML for final results
m1best<-m1<-gls(log(dirt_mod_quanti+0.2216441)/(1-dirt_mod_quanti+0.2216441) ~ logsize, data=data, method="REML",correlation=corSpher(form=~x+y))
summary (m1best)

##############Nestedness###########################
hist(data$wnodf)
## first, REML to compare fixed terms
m1<-gls(wnodf ~ intensity+def+forest.type, data=data,method="REML")# 
...
### second, fit ML for best model selection Zuur, pg 90
m1<-gls(wnodf~ logsize+logarea+forest.type, data=data, method="ML", correlation=corSpher(form=~x+y))
summary(m1)
dd<-dredge(m1)
print(dd)
summary(get.models(dd,1)[[1]])
...
## finally, refit best models with REML for final results
m1best<-m1<-gls(wnodf ~ intensity+logarea, data=data, method="REML",correlation=corSpher(form=~x+y))
summary (m1best)

m2best<-m1<-gls(wnodf ~ logsize, data=data, method="REML",correlation=corSpher(form=~x+y))
summary (m2best)
...
### second, fit ML for best model selection Zuur, pg 90
m1<-gls(log(h2+0.0673)/(1-h2+0.0673)~ logsize+logarea+forest.type, data=data, method="ML", correlation=corSpher(form=~x+y))
summary(m1)
dd<-dredge(m1)
print(dd)
summary(get.models(dd,1)[[1]])
...
## finally, refit best models with REML for final results
m1best<-m1<-gls(log(h2+0.0673)/(1-h2+0.0673) ~ logsize, data=data, method="REML",correlation=corSpher(form=~x+y))
summary (m1best)
...
### second, fit ML for best model selection Zuur, pg 90
m1<-gls(log(evenness+0.5514)/(1-evenness+0.5514)~ logsize+logarea+forest.type, data=data, method="ML", correlation=corSpher(form=~x+y))
summary(m1)
dd<-dredge(m1)
print(dd)
summary(get.models(dd,1)[[1]])
...
## finally, refit best models with REML for final results
m1best<-gls(log(evenness+0.5514)/(1-evenness+0.5514) ~ logarea, data=data, method="REML",correlation=corSpher(form=~x+y))
summary (m1best)

plot(log(data$evenness+0.5514)/(data$evenness+0.5514)~logarea)
abline(m1best)
